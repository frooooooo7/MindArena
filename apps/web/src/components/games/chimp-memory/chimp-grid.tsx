...
export const ChimpGrid = memo(function ChimpGrid({
  cells,
  disabled,
  onCellClick,
}: ChimpGridProps) {
        ...
        return (
          <button
            ...
            className={cn(
              ...
              isHidden &&
                "bg-linear-to-br from-slate-600 to-slate-700 hover:from-slate-500 hover:to-slate-600 cursor-pointer shadow-md",
              isCompleted &&
